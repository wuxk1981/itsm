...
public class Common {
	//后台访问
	public static final String BACKGROUND_PATH = "WEB-INF/views/background/";
	public static final String LOGIN_PAGE_PATH = "WEB-INF/views/";
	//前台访问
	public static final String WEB_PATH = "/WEB-INF/views/web/";
	//默认除法运算精度
